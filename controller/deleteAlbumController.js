...
module.exports = {
     ...
     */
    /**
        * This function would request info of the user ID and requirs that he is an artist.
        * It searches the collection of users and albums and finds the particular album that the artist wants to delete. 
        *  It would delete this album and update the info of the artist and the collection of albums.
        ...
        * @param {*} albumId the ID of the song in mongoDB that will be deleted
        * @param {string} albumName the name of the songs that would be deleted
        ...
        mongoose.connection.db.collection('users', function(err, collection){
            ...
            collection.find({type:"Artist"},{_id:new ObjectId(req.body.artistId)}).toArray( function(err,docs) {
                ...
                mongoose.connection.db.collection('albums', function(err, collection2){
                     ...
                     collection2.find({_id:new ObjectId(req.body.albumId)}, {name: req.body.albumName}).toArray( function(err,docs) {
                         if (err){
                             throw err
                         }
